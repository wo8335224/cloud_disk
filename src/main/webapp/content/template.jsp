...
<head>
    ...
    <!-- Google Fonts-->
    <link href='<%=request.getContextPath() %>/assets/css/googleapis.css' rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="<%=request.getContextPath() %>/assets/js/Lightweight-Chart/cssCharts.css"> 
</head>
...
<body>
	...
	<script src="<%=request.getContextPath() %>/assets/js/easypiechart.js"></script>
	<script src="<%=request.getContextPath() %>/assets/js/easypiechart-data.js"></script>
	
	 <script src="<%=request.getContextPath() %>/assets/js/Lightweight-Chart/jquery.chart.js"></script>
